         ...
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0 text-dark">Liste des dons
                  <span class="m-0 text-dark">( {{$project->project_title}} )</span>
                  <a class="btn btn-primary back_new" href="{{route('admin.project-management.add-donation',encrypt($project->id, Config::get('Constant.ENC_KEY')))}}">Ajouter un don</a>
               </h1>
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a href="{{route('admin.project-management.project-list')}}">Projets</a></li>
            ...
            <div class="col-12">
               ...
               <div class="card card-primary">
                  <div class="card-header">
                     <h3 class="card-title">{{$panel_title}}  <span class="m-0 text-dark">{{ $sum }} <small>Approved</small></span>                               
                     </h3>

                     <h3 class="card-title add-right">
                        <span class="m-0 text-dark">
                       @php /*<a href="{{ route('admin.project-management.donation-download',  encrypt($project->id, Config::get('Constant.ENC_KEY'))) }}"><i class="fas fa-download"></i></a>   */ @endphp

                        <a href="{{route('admin.project-management.add-donation',encrypt($project->id, Config::get('Constant.ENC_KEY')))}}"><i class="fa fa-plus"></i></a>

                        <form action="{{route('admin.project-management.donation-list', $project_id)}}" method='GET'  id='Credit_User'>
                           {{csrf_field()}}
                           <input type='hidden' name='project_id' value='{{$project_id}}'/>
                           <button type='submit' name='export' value="yes" tabindex='8' class='btn export'><i class='fas fa-download'></i></button>
                        </form>
                        </span>
                     ...
                     @php /*<h3 class="card-title add-right">
   ...
   jQuery(document).ready(function () {
       ...
       oTable = $('#site-donation-table').DataTable({
           ...
           ajax: {
               ...
               url: "{!! route('admin.project-management.donation-list-table',  encrypt($project->id, Config::get('Constant.ENC_KEY'))); !!}",
