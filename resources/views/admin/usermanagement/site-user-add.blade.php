...
<div class="content-wrapper">
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0 text-dark">Ajouter un porteur de projet</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active"> Ajouter un porteur de projet</li>
               </ol>
            </div>
            <!-- /.col -->
         </div>
   		...
   		<div class="row">
   			<div class="col-12">
                  ...
                  <div class="card-body">
                     ...
                     @endif
                     <form action="{{route('admin.user-management.user-add-save')}}" method="POST" id="user-add">
                        {{ csrf_field() }}
                        <div class="row">
                        	<div class="col-md-10">
                        		<div class="form-group row">
	                                 ...
	                                 <div class="col-sm-10">
	                                    <input type="text" name="last_name" id="last_name" value="" class="form-control" placeholder="Nom" title="Nom" required>
	                            ...
	                            <div class="form-group row">
	                                 ...
	                                 <div class="col-sm-10">
	                                    <input type="text" name="first_name" id="first_name" value="" class="form-control" placeholder="Prénom" title="Prénom" required>
	                            ...
	                            <div class="form-group row exclude">
	                                 ...
	                                 <div class="col-sm-10">
	                                    <input type="text" name="address" id="address" value="" class="form-control" placeholder="Adresse" title="Adresse" required>
	                            ...
	                            <div class="form-group row exclude">
	                                 ...
	                                 <div class="col-sm-10">
	                                    <input type="text" name="postal_code" id="postal_code" value="" class="form-control" placeholder="Code postal" title="Code postal" required>
	                            ...
	                            <div class="form-group row exclude">
	                                 ...
	                                 <div class="col-sm-10">
	                                    <input type="text" name="village" id="village" value="" class="form-control" placeholder="Ville" title="Ville" required>
	                            ...
	                            <div class="form-group row">
	                                 ...
	                                 <div class="col-sm-10">
	                                 	<div class="input-group">
	                                 		<input type="text" name="password" id="password" value="" class="form-control input-lg" placeholder="Mot de passe" title="Mot de passe"  rel="gp" data-size="10" data-character-set="a-z,A-Z,0-9,#">
